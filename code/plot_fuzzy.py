...
# Define the membership functions for Node Attestation
...
# Plot membership functions for Proof of Transit Result
...
# Plot membership functions for Number of Nodes
plt.subplot(2, 2, 2)
...
# Plot membership functions for Node Attestation
plt.subplot(2, 2, 3)
...
# Plot membership functions for Network Trust
plt.subplot(2, 2, 4)
